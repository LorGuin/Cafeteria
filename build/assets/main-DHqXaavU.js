function i(e){const a=document.createElement("div");return e&&e.goTo("/inicio"),a.className="init-page",a.innerHTML=`
    ...
    `,a}function n(e){const a=document.createElement("div");return e&&e.goTo("/nosotros"),a.className="init-nosotros",a.innerHTML=`
    ...
    `,a}function c(e){const a=document.createElement("div");return e&&e.goTo("/proceso"),a.className="init-proceso",a.innerHTML=`
    ...
    `,a}function r(e){const a=document.createElement("div");return e&&e.goTo("/menu"),a.className="init-menu",a.innerHTML=`
    <header class="header header-nosotros">
        <div class="contenido-header contenedor">
        <barra-menu></barra-menu>
        <div class="texto-header">
    ...
    `,a}function t(e){const a=document.createElement("div");return e&&e.goTo("/galeria"),a.className="init-proceso",a.innerHTML=`
    ...
    `,a}function l(e){const a=document.createElement("div");return e&&e.goTo("/contacto"),a.className="init-proceso",a.innerHTML=`
    ...
    `,a}const d=[{pathRegex:/^\/inicio$/i,render:({goTo:e})=>i({goTo:e})},{pathRegex:/^\/$/i,render:({goTo:e})=>i({goTo:e})},{pathRegex:/^\/nosotros$/i,render:({goTo:e})=>n({goTo:e})},{pathRegex:/^\/proceso$/i,render:({goTo:e})=>c({goTo:e})},{pathRegex:/^\/menu$/i,render:({goTo:e})=>r({goTo:e})},{pathRegex:/^\/galeria$/i,render:({goTo:e})=>t({goTo:e})},{pathRegex:/^\/contacto$/i,render:({goTo:e})=>l({goTo:e})}];function p(e){window.history.pushState({},"",e),s(e)}function s(e){const a=d.find(o=>o.pathRegex.test(e));if(a){const o=document.querySelector(".root");o&&(o.innerHTML="",o.appendChild(a.render({goTo:p})))}else console.warn(`el path "${e}" no ha sido encontrado`)}function m(){const e=window.location.pathname,a="/cafeteria";return e.startsWith(a)?e.replace(a,"")||"/":e}function g(){const e=m();s(e)}customElements.define("barra-menu",class extends HTMLElement{shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){const e=document.createElement("link");e.rel="stylesheet",e.href="../../scss/app.scss",this.shadow.appendChild(e);const a=document.createElement("div");a.className="barra-menu",a.innerHTML=`
        <div class="barra"> 
          <div class="logo">
        ...
        `,a.querySelector(".boton-inicio")?.addEventListener("click",()=>{window.location.href="/inicio"}),a.querySelector(".boton-nosotros")?.addEventListener("click",()=>{window.location.href="/nosotros"}),a.querySelector(".boton-proceso")?.addEventListener("click",()=>{window.location.href="/proceso"}),a.querySelector(".boton-menu")?.addEventListener("click",()=>{window.location.href="/menu"}),a.querySelector(".boton-galeria")?.addEventListener("click",()=>{window.location.href="/galeria"}),a.querySelector(".boton-contacto")?.addEventListener("click",()=>{window.location.href="/contacto"}),this.shadow.appendChild(a)}});customElements.define("menu-cafeteria",class extends HTMLElement{shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){const e=document.createElement("link");e.rel="stylesheet",e.href="../../scss/app.scss",this.shadow.appendChild(e);const a=document.createElement("div");a.className="menu-cafeteria",a.innerHTML=`
        ...
        `,this.shadow.appendChild(a)}});customElements.define("footer-cafeteria",class extends HTMLElement{shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"})}connectedCallback(){const e=document.createElement("link");e.rel="stylesheet",e.href="../../scss/app.scss",this.shadow.appendChild(e);const a=document.createElement("footer");a.className="footer-cafeteria",a.innerHTML=`
            <footer class="footer">
        ...
        `,this.shadow.appendChild(a)}});(function(){document.addEventListener("DOMContentLoaded",()=>{g()})})();
//# sourceMappingURL=main-DHqXaavU.js.map
